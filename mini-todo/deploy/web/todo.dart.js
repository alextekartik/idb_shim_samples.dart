...
if(0>=z.length)return H.e(z,0)
z.pop()},
static:{"^":"Gs,TM,CJ,hG,No,HV,dH,SW,KQ,i6,mr,YM,PB,Xk",TC:function(a,b){var z
b=P.DY()
z=P.p9("")
new P.Sh(b,z,[]).C7(a)
...
this.h7=w+1
if(x==null){y.sYa(this)
w=z.MM
if(w.Gv!==0)H.vh(new P.lj("Future already completed"))
w.rX(this)
this.o8()}else if(x===this){this.o8()
w=z.MM
if(w.Gv!==0)H.vh(new P.lj("Future already completed"))
w.rX(this)}else return x.mh.MM.ml(new L.X8(this))
return w},
o8:function(){P.Ab(null,null).ml(new L.SX(this))},
...
return P.Ab(z,null)},
KQ:function(){if(this.h7===0)P.Ab(null,null).ml(new L.MF(this))},
...
call$1:function(a){var z,y,x
z=this.a
if(z.h7===0){y=H.Go(z.IL,"$isfv").gYa()
if(y!==z&&y!=null){P.JS("error "+H.eQ(z)+" "+H.d(z))
H.vh(new P.lj("internal error - complete - not the current transaction"))}x=H.Go(z.IL,"$isUo")
x.At=null
y=z.mh.MM
if(y.Gv!==0)H.vh(new P.lj("Future already completed"))
y.OH(x)
